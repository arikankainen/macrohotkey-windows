...
namespace MacroHotkey
{
    public partial class Form1
    {
        ...
        private void hook_KeyPressed(object sender, KeyPressedEventArgs e)
        {
            ...
            if (checkActive.Checked) RunAction(GetAction(e.Modifier.ToString(), e.Key.ToString()));
        }
        ...
        {
            if (ms < 1) return;
            DateTime desired = DateTime.Now.AddMilliseconds(ms);
        ...
        {
            this.Text = "Running macro... Press 'Ctrl-Break' to cancel";
        ...
        private void RunRow(string row)
        {
            try
            {
                ...
                else if (command == "mousemove")
                {
                    ...
                    int x = 0, y = 0;
                    Int32.TryParse(position[0], out x);
                    Int32.TryParse(position[1], out y);
                ...
                else if (command == "mousemovemonitor")
                {
                    ...
                    else Int32.TryParse(value, out screenNumber);
